...
window.setTimeout(function() {
  ...
  if(adBlockEnabled===true){
	...
	document.body.innerHTML='<div class="container">'+
	'<div class="mt-1 mw720 center text-left borbox ">'+
	'<h1 class="mw720 center text-left " style="color: #6450a5;"><img src="static/img/logo.svg" style="max-width: 38px; vertical-align: bottom;"> Hi there, welcome to LFJ service...</h1>'+
